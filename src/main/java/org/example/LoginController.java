...
import org.example.client.chatwindow.ChatController;
import org.example.client.chatwindow.Listener;
import org.example.client.util.ResizeHelper;
...
public class LoginController implements Initializable {
    @FXML public ImageView Defaultview;
    @FXML public ImageView Sarahview;
    @FXML public ImageView Dominicview;
    @FXML public  TextField hostnameTextfield;
    @FXML public TextField portTextfield;
    @FXML public TextField usernameTextfield;
    @FXML public ChoiceBox imagePicker;
    @FXML public Label selectedPicture;
    ...
    public void loginButtonAction() throws IOException {
        ...
        FXMLLoader fmxlLoader = new FXMLLoader(getClass().getResource("/xml/ChatView.fxml"));
