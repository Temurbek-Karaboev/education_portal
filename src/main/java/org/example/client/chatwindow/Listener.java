...
import static org.example.messages.MessageType.CONNECTED;

public class Listener implements Runnable{

    public static final String HASCONNECTED = "has connected";
